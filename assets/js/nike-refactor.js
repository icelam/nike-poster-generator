...
var nikePosterGenerator = function() {
  ...
  var _drawImageOnCanvas = function(file, brightness, contrast) {
    //performance tuning - canvas is rendering
    isRendering  = true;
    ...
    img.onload = function() {
      ...
      ctx.drawImage(logo, 0, 0, 
                    ...
                    ((canvas.width - (logoWidth)) / 2), (canvas.height - (canvas.height * 0.09)), 
      ...
      //performance tuning - canvas finish drawing, redraw when needed
      isRendering  = false;
      if(isQueued) {
        _handleFiles();
        isQueued = false;
